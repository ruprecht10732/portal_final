  ...
  template: `
    <div class="flex flex-col w-full gap-1.5 text-left">
      ...
      <input
        ...
        class="w-full px-4 py-3 text-sm bg-white border transition-all duration-200 focus:outline-none disabled:opacity-50 disabled:bg-zinc-50 disabled:cursor-not-allowed placeholder:text-zinc-400"
