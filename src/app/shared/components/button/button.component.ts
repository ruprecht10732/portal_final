...
@Component({
  ...
  class="relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-lg transition-all duration-200 ease-out cursor-pointer touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] min-w-[44px] md:min-h-0 md:min-w-0 data-[variant=primary]:bg-zinc-900 data-[variant=primary]:text-white data-[variant=primary]:shadow-sm data-[variant=primary]:hover:bg-zinc-800 data-[variant=primary]:active:scale-[0.98] data-[variant=secondary]:bg-white data-[variant=secondary]:text-zinc-900 data-[variant=secondary]:ring-1 data-[variant=secondary]:ring-inset data-[variant=secondary]:ring-zinc-200 data-[variant=secondary]:hover:bg-zinc-50 data-[variant=secondary]:active:scale-[0.98] data-[variant=ghost]:bg-transparent data-[variant=ghost]:text-zinc-600 data-[variant=ghost]:hover:bg-zinc-100 data-[variant=ghost]:hover:text-zinc-900 data-[variant=ghost]:active:scale-[0.98] data-[variant=ghost]:active:bg-zinc-200 data-[variant=danger]:bg-red-600 data-[variant=danger]:text-white data-[variant=danger]:hover:bg-red-700 data-[variant=danger]:shadow-sm data-[size=default]:px-4 data-[size=default]:py-2.5 data-[size=default]:text-base data-[size=default]:font-medium md:data-[size=default]:px-4 md:data-[size=default]:py-2 md:data-[size=default]:text-sm data-[size=compact]:px-3 data-[size=compact]:py-2 data-[size=compact]:text-sm data-[size=compact]:font-medium md:data-[size=compact]:text-xs md:data-[size=compact]:py-1.5 data-[icon-only=true]:p-0 data-[icon-only=true]:w-[44px] md:data-[icon-only=true]:w-auto md:data-[icon-only=true]:px-0 data-[shape=square]:aspect-square md:data-[shape=square]:h-10 md:data-[shape=square]:w-10 data-[stacked=true]:flex-col data-[stacked=true]:gap-1 data-[stacked=true]:h-auto data-[stacked=true]:py-4 data-[full-width=true]:w-full"
>
  @if (loading()) {
