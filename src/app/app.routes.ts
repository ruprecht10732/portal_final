...
const settingsPanelItems: SidebarPanelConfig['panelItems'] = [
	...
	{ group: 'sidebar.groups.automation', label: 'navigation.agentApprovals', route: '/app/settings/agent-approvals', icon: 'shield', roles: ['admin'] },
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						canActivate: [adminGuard],
						loadComponent: () => import('./routes/agent-approvals/agent-approvals.component').then(m => m.AgentApprovalsComponent),
					},
				],
			},
			{
