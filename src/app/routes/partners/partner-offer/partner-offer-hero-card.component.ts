        ...
        <div class="overflow-hidden rounded-[28px] bg-slate-950 text-white shadow-[0_18px_40px_-18px_rgba(15,23,42,0.7)]">
          ...
          <div class="p-5">
            ...
            <div class="mt-5 grid grid-cols-2 gap-3">
              ...
              <div class="rounded-2xl bg-white/8 px-4 py-3">
                <div class="flex items-center gap-2 text-slate-300">
                  <svg class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v4a1 1 0 00.293.707l2 2a1 1 0 101.414-1.414L11 10.586V7z" clip-rule="evenodd"/></svg>
                  <p class="text-[11px] font-bold uppercase tracking-[0.18em]">{{ 'partners.offer.snapshotStatus' | translate }}</p>
                </div>
                <p class="mt-2 text-sm font-semibold text-white">{{ statusLabelKey() | translate }}</p>
              </div>
            </div>
        ...
        <div class="p-7">
          <div class="grid gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(300px,0.9fr)] xl:items-start">
            <div class="min-w-0">
              ...
              <p class="mt-3 max-w-3xl text-base leading-7 text-slate-600">{{ summaryIntro() }}</p>
            ...
            <div class="grid gap-4 lg:grid-cols-2 xl:grid-cols-1">
              ...
              <div class="rounded-3xl bg-slate-50 px-5 py-5 ring-1 ring-slate-200">
                <p class="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">{{ 'partners.offer.snapshotQuickView' | translate }}</p>
                <div class="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                  ...
                  <div>
                    <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-400">{{ 'partners.offer.snapshotDeadline' | translate }}</p>
          ...
          <div class="mt-6 grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(260px,0.8fr)]">
            ...
            @if (constructionYearDisplay() || scopeDisplay()) {
              <div class="rounded-2xl bg-slate-50 px-4 py-4">
                <p class="text-[11px] font-bold uppercase tracking-[0.18em] text-slate-400">{{ 'partners.offer.snapshotDetails' | translate }}</p>
